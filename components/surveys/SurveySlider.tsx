    ...
    <div className="w-full flex flex-col gap-3">
      <div className="flex flex-wrap lg:flex-nowrap items-center justify-between gap-3 bg-[#14171F] p-3 md:p-4 rounded-xl border border-white/5">
        <div className="flex items-center gap-2 shrink-0">
          ...
          <h2 className="text-base font-black text-white whitespace-nowrap">Top Surveys</h2>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0 ml-auto">
          ...
          <Link href="/surveys" className="text-[11px] font-bold text-white bg-[#8B5CF6]/20 px-3.5 py-2 rounded-lg border border-[#8B5CF6]/30 hover:bg-[#8B5CF6]/40 transition-colors whitespace-nowrap">
            View All
          </Link>
        </div>
      </div>
